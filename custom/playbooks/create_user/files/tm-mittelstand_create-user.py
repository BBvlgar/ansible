...
def createUser(browser, lastname, firstname, mail, password):
    ...
    element = WebDriverWait(browser, 60).until(
        EC.presence_of_element_located((By.XPATH, "//li[contains(text(),'Microsoft 365 Business Standard')]"))
    )

    browser.find_element_by_xpath("//li[contains(text(),'Microsoft 365 Business Standard')]").click()
